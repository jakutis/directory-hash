...
main = hspec $ do
  ...
  describe "main, called with [\"./test/fixtures/e\"]" $ do
    it "produces correct output" $
      let e = "[{\"sha512\":\"87c568e037a5fa50b1bc911e8ee19a77c4dd3c22bce9932f86fdd8a216afe1681c89737fada6859e91047eece711ec16da62d6ccb9fd0de2c51f132347350d8c\",\"name\":\"/e/e\"}]"
        in capture_ (catch (DirectoryHash.Executable.main ["./test/fixtures/e"]) ((\_ -> return ()) :: ExitCode -> IO ())) `shouldReturn` e
